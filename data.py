...
def init_train_dataset(config):
    ...
    train_loader = DataLoader(dataset=train_data, batch_size=batch_size, shuffle=config.shuffle,
                              num_workers=config.reader_num)
    valid_loader = DataLoader(dataset=dev_data, batch_size=batch_size, shuffle=config.shuffle,
                              num_workers=config.reader_num)
    test_loader = DataLoader(dataset=test_data, batch_size=batch_size, shuffle=config.shuffle,
                             num_workers=config.reader_num)
